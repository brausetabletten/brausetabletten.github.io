...
Although I am not sure that this is what the N64 and GC F-Zero games are doing (or more precisely: I am pretty sure this is not what they are doing), my idea was that the vehicles should move on a 2D parameterized manifold in 3D space that is the track. In other words, the movement shall be constrained to the track mesh, as long as the vehicle is "on the track". As soon as a vehicle leaves the track, the movement shall be determined from the last velocity on the track and the global gravity, with some steering allowed.  
